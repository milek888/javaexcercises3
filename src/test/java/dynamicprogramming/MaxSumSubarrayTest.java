...
import dynamicprogramming.contigoussubarray.MaxSumSubarray;
...
class MaxSumSubarrayTest {
    ...
    void shouldCalculateWithAllPositive() {
        ...
        int actualSum = MaxSumSubarray.calculateSumForPositives(inputNumbers);
        int expectedSum = 55;
    ...
    void shouldCalculXXX() {
        ...
        int actualSum = MaxSumSubarray.calculateSumForIntegers(inputNumbers);
        int expectedSum = 9;
